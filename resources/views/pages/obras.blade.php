...
<div class="container" style="width: 89%">
            ...
            <div class="row center bloquecont">
                <div class="items-cat col l12 s12 m12" style="margin-bottom: 10%;position: relative;right: 20px;">
                            ...
                            <div class="col l4 s12 m4">
                                <div class="div-product" style="height: 355px!important;">
  ...
  <div id="modal{!! $obra->id !!}" class="modal" style="height: 555px!important;max-height: 950px!important; " style="height: 558px!important;max-height: 571px!important;">
    <div class="modal-content">
        <h4 style="font-family: 'Source Sans Pro', sans-serif;font-size: 26px;color: #A70000;">{!! $obra->nombre !!}<a href="#!" class="right modal-close waves-effect waves-green btn-flat" style="font-family: 'Source Sans Pro', sans-serif;font-size: 14px;color: #777777;font-weight: bold;margin-bottom: 5%;">Cerrar</a></h4>
        <div class="row">
