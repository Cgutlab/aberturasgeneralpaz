          ...
          <div class="right hide-on-med-and-down">
            <div class="redes-header" style="word-spacing: 10px;">
              <img src="{{asset('img/redes/whatsapp.jpg')}}"><a href="{{ url('servicios') }}" style="color: #595959;font-size: 16px;font-family: 'Source Sans Pro', sans-serif;word-spacing: 3px;"> Whats App · {{ $telefono2->descripcion}}    </a>
                  ...
                  <a style="color: black;"> |</a>
                  @if($activo=='trabaja')
                  <a class="activo" href="{{ url('trabaja') }}" style="color: black;    word-spacing: 1px;"> TRABAJA CON NOSOTROS      </a>
                  @else
                  <a href="{{ url('trabaja') }}" style="color: black;    word-spacing: 1px;"> TRABAJA CON NOSOTROS      </a>
                  @endif
              ...
              <a href="{{ $facebook->link}}" class="iconos-redes" target="_blank"><img src="{{asset('img/redes/facebook.jpg')}}"></a>
              <a href="{{ $instagram->link}}" class="iconos-redes" target="_blank"><img src="{{asset('img/redes/instagram.jpg')}}"></a>
